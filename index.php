        ...
        <script type="text/javascript">
            bioEp.init({
                html: '<div id="bio_ep_content">' +
                        ...
                        '<h1 style="width:100%; float:left" >NÃO ENCONTROU UM IMÓVEL?</h1>' +                       
                        '<p style="font-size: 24px; margin-top: 15px; margin-bottom: 15px">Fale com um de nossos atendentes tenho certeza que eles vão poder lhe ajudar!</p>' +
                        '<h1>(61) 3315.8587</h1>' +
                        
                        '</div>',
                css: '#bio_ep {width: 600px; height: 500px; color: #333; background-color: #fff; text-align: center; padding:25px;  font-size: 36px; font-weight:bold;}' +                        
